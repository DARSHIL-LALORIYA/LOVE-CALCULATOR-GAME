...
calcBtn.addEventListener("click", function (e) {
  ...
  //lovescore conditions
    ...
    loveInfo.innerHTML =
      ...
      capitalize_Words(theirName.value) +
      "</b>" +
      " love each other like jonny depp and ambet heart. Seems to be like one sided love.";
    ...
    loveInfo.innerHTML =
      ...
      capitalize_Words(theirName.value) +
      "</b>" +
      " love each other like Romeo & Juliet.";
    ...
    loveInfo.innerHTML =
      ...
      capitalize_Words(theirName.value) +
      "</b>" +
      " love each other like titanic . This relationship can be sink at any time.";
